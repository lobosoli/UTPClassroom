...
def main():    
    ...
    if os.path.isfile("ClassRoomNumStudents5.xlsx"):
        ...
        for course in courses:
            ...
            while page_token != None:
                for course in courses:
                    ...
                    wb.save(filename = "ClassRoomNumStudents5.xlsx")                    
                
                page_token = results.get('nextPageToken',None)
                results = classroom_service.courses().list(pageToken = page_token, pageSize = 500).execute()
                courses = results.get('courses', [])
